...
class interIIT():
	...
	def defSetGpioPins():
		self.pinsUSpidEchos = {"pid1":1,"pid2":2,"pid3":3}
		self.pinsUSpidTrigs = {"pid1":5,"pid2":6,"pid3":7}
		self.pinsUSfrontEcho = 4
		self.pinsUSfrontTrig = 8
		...
		self.pinsColorS2 = 11
		self.pinsColorS3 = 12
		self.pinsColorSenOut = 12

		GPIO.setup(self.pinsColorS0, GPIO.OUT)
		GPIO.setup(self.pinsColorS1, GPIO.OUT)
		GPIO.setup(self.pinsColorS2, GPIO.OUT)
		GPIO.setup(self.pinsColorS3, GPIO.OUT)
		GPIO.setup(self.pinsColorSenOut, GPIO.IN)
	...
	def defSensorConst(self):
		...
		self.ssColorRead = {"front":[0,0,0],"back":[0,0,0]}
	...
	def ssReadUS(self):
		for pin in self.ssUSpidRead:
			...
			self.ssUSpidRead[pin] = timeElapsed*17150
		...
		self.ssUSfrontRead = timeElapsed*17150

	def ssColorRead(self):
